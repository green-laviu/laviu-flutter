...
final chatRepositoryProvider = Provider.family<ChatRepository, (String wsUrl, String jwt, String streamKey)>((
  ...
  final repo = ChatRepository(wsUrl: wsUrl, jwt: jwt, streamKey: streamKey);
  ref.onDispose(repo.dispose);
  return repo;
});

/// 연결 상태 스트림 (연결 아이콘/토스트 등에 사용)
final chatConnStateProvider = StreamProvider.family<ChatConnState, (String wsUrl, String jwt, String streamKey)>((
  ref,
  args,
) {
